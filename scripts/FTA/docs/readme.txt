*****************************************************************************
* FTA - Create Proxy user in dlvr,test env for fta datafixes		    *
...
1) From the ddl folder, log in to database as the schema owner and execute the SET statements before running the scripts
