 ...
 * 																																			 *
 *************************************************************************/
SPOOL LOGS\Create_FSA_CLIENT_PROXY_USER_ROLE.LOG 
DROP USER PROXY_FSA_CLIENT_API CASCADE;

CREATE USER PROXY_FSA_CLIENT_API.
  IDENTIFIED BY &PROXY_FSA_CLIENT_API
  DEFAULT TABLESPACE USERS
  TEMPORARY TABLESPACE TEMP
  PROFILE NRS_NOEXPIRY_PROFILE
  ACCOUNT UNLOCK;
  GRANT CREATE SESSION PROXY_FSA_CLIENT_API;

  grant FSA_API_ROLE to PROXY_FSA_CLIENT_API ;
