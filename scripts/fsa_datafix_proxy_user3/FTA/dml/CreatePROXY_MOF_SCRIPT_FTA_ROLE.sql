...
grant SELECT, UPDATE on THE.CUT_BLOCK to PROXY_MOF_SCRIPT_FTA_ROLE;
grant SELECT, UPDATE on THE.CUT_BLOCK_AMEND_GEOM to PROXY_MOF_SCRIPT_FTA_ROLE;
grant SELECT, UPDATE on THE.CUT_BLOCK_GEOM to PROXY_MOF_SCRIPT_FTA_ROLE;
...
grant SELECT, UPDATE on THE.HARVEST_AMEND to PROXY_MOF_SCRIPT_FTA_ROLE;
grant SELECT, UPDATE on THE.LAND_USE_AMEND_GEOM to PROXY_MOF_SCRIPT_FTA_ROLE;
grant SELECT, UPDATE on THE.LAND_USE_GEOM to PROXY_MOF_SCRIPT_FTA_ROLE;
grant SELECT, UPDATE on THE.HARVEST_AUTHORITY_AMEND_GEOM to PROXY_MOF_SCRIPT_FTA_ROLE;
grant SELECT, UPDATE on THE.CUT_BLOCK_OPEN_ADMIN to PROXY_MOF_SCRIPT_FTA_ROLE;
grant SELECT, UPDATE on THE.HARVEST_AUTHORITY_GEOM to PROXY_MOF_SCRIPT_FTA_ROLE;
...
grant SELECT, UPDATE on THE.RANGE_TENURE_GEOM to PROXY_MOF_SCRIPT_FTA_ROLE;
grant SELECT, UPDATE on THE.RANGE_TENURE_AMEND_GEOM to PROXY_MOF_SCRIPT_FTA_ROLE;
